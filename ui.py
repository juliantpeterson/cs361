...
# March 11, 2025 - integrated Russel's microservice
#------------------------------------------------------------
...
class Navigation:
    ...
    def main_menu():
        while True:
            ...
            if main_input in ('3', "EXIT"):
                quit()
            elif main_input in ('2', 'LOGIN'):
                Navigation.login()
    ...
    def login():
        ...
        while success is False:
            ...
            if login_input == '1':
                login_attempt = dict()
                login_attempt['username'] = input("Please enter username: ")
                login_attempt['password'] = input("Please enter password: ")
...
4. View World Series Championship years
...
MAIN to return to main menu
            ...
            if user_input == "BACK":
                ...
                socky = context.socket(zmq.REQ)
                socky.connect('tcp://localhost:4040')
                socky.send_string(team_name)

                # payload
                roster_json = socky.recv_json()
                ...
                print("prev 5 games!")
                continue
            elif user_input in ("4", "View World Series Championship years"):
                host_name = '127.0.0.1'
                port_num = 4569
                ...
                while True:
                    chars_arrive = client.recv(1024)
                    print(chars_arrive.decode())
